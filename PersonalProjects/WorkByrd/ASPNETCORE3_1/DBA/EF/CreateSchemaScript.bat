...
REM 
dotnet ef migrations script --idempotent --project "WorkByrdLibrary.csproj" --startup-project "../WorkByrdServer/WorkByrdServer.csproj" --verbose --output "../DBA/EF/schema.sql"
cd ../DBA/EF
